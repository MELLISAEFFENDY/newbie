...
local function BuildUI()
    ...
    fishingAITabBtn.Position = UDim2.new(0, 5, 0, 5)
    fishingAITabBtn.Text = "Fishing AI"
    fishingAITabBtn.Font = Enum.Font.GothamBold
    fishingAITabBtn.TextSize = 16
    fishingAITabBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 48)
